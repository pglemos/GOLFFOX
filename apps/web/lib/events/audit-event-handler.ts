...
eventPublisher.subscribe('CompanyDeleted', auditHandlerFn)
eventPublisher.subscribe('VehicleCreated', auditHandlerFn)
eventPublisher.subscribe('VehicleUpdated', auditHandlerFn)
eventPublisher.subscribe('VehicleDeleted', auditHandlerFn)
eventPublisher.subscribe('UserCreated', auditHandlerFn)
eventPublisher.subscribe('UserUpdated', auditHandlerFn)
eventPublisher.subscribe('UserDeleted', auditHandlerFn)
eventPublisher.subscribe('DriverCreated', auditHandlerFn)
eventPublisher.subscribe('DriverUpdated', auditHandlerFn)
eventPublisher.subscribe('RouteCreated', auditHandlerFn)
eventPublisher.subscribe('RouteUpdated', auditHandlerFn)
eventPublisher.subscribe('CarrierCreated', auditHandlerFn)
eventPublisher.subscribe('CarrierUpdated', auditHandlerFn)
