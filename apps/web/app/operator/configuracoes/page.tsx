        ...
        <Card className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="relative">
              <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-orange-500 flex items-center justify-center shadow-lg overflow-hidden">
                {profileImage ? (
                  <img 
                    src={profileImage} 
                    alt="Foto de perfil" 
            ...
            <div className="flex-1">
              ...
              {uploadingImage && (
                <p className="text-sm text-orange-500">Fazendo upload...</p>
              )}
            </div>
          </div>
        </Card>
