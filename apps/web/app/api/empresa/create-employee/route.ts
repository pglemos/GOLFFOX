/**
 * DEPRECATED: Esta rota foi movida para /api/operador/create-employee
...
export async function POST(request: NextRequest) {
  ...
  const newUrl = new URL('/api/operador/create-employee', request.url)
  ...
  return new NextResponse(responseData, {
    ...
    headers: {
      ...
      'X-New-Route': '/api/operador/create-employee'
    }
  })
}
