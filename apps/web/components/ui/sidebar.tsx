...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Gap spacer - empurra o conteúdo para a direita */}
      <div
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-4 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-4",
        className
      )}
      {...props}
    />
...
function SidebarInput({
  ...
  return (
    <input
      ...
      className={cn(
        "bg-background focus-visible:ring-sidebar-ring h-8 w-full rounded-md border px-2 text-sm shadow-sm focus-visible:ring-2 focus-visible:outline-hidden",
        className
      )}
      {...props}
    />
