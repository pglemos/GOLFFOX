    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close className={cn(
          "ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none touch-manipulation",
          "right-4 top-4 min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0"
        )}>
          <X className="h-4 w-4" />
