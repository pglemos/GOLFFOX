        ...
        <div className="grid gap-4 sm:gap-6 py-2 sm:py-4">
          ...
          <div className="grid gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              {file && (
                <span className="text-sm text-ink-muted truncate">{file.name}</span>
              )}
            </div>
            ...
            <div className="p-3 rounded-lg bg-error-light border border-error-light">
              ...
              <ul className="text-xs text-error space-y-1 max-h-32 overflow-y-auto">
                ...
                {parseErrors.length > 10 && (
                  <li className="text-ink-muted">... e mais {parseErrors.length - 10} erros</li>
                )}
              </ul>
            </div>
          )}
                  ...
                  <tbody>
                    {preview.map((row, i) => (
                      <tr key={i} className="border-t border-border-light">
                        ...
                        <td className="p-1 text-ink-muted truncate max-w-[200px]" title={row.endereco}>
              ...
              <div className="p-3 rounded-lg bg-success-light border border-success-light">
                ...
                <div className="text-xs text-success space-y-1">
                  ...
                  {importResult.errors && importResult.errors.length > 0 && (
                    <p className="text-error">✗ {importResult.errors.length} erros</p>
                  )}
