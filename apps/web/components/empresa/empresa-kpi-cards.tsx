...
/**
 * EmpresaKPICards - Cards de KPIs para o painel da Empresa Contratante
 * @deprecated Use EmpresaKPICards ao invés de OperatorKPICards
 */
export const EmpresaKPICards = memo(function EmpresaKPICards({ kpis, loading = false }: KPICardsProps) {
    if (loading) {
        return (
...
export const OperatorKPICards = EmpresaKPICards
