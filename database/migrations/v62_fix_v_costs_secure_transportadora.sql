...
LEFT JOIN public.carriers car ON car.id = c.transportadora_id  -- Usa transportadora_id (migração completa)
...
COMMENT ON VIEW public.v_costs_secure IS 'View segura de custos com joins para nomes (RLS aplicado via tabela base). Usa transportadora_id.';
