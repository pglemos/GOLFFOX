...
class _RoutesPageState extends ConsumerState<RoutesPage> {
        ...
        children: [
          ...
          Expanded(
            child: routesAsync.when(
              data: (routes) => _buildRoutesList(routes),
  ...
  Widget _buildRoutesList(List<BusRoute> routes) {
    ...
    return RefreshIndicator(
      onRefresh: () async {
        ref.refresh(routesStreamProvider);
      },
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: GfTokens.space4),
          ElevatedButton.icon(
            onPressed: () => ref.refresh(routesStreamProvider),
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).pop();
              _navigateToCreateRoute(isAutoGenerated: false);
            },
  ...
  void _startRoute(BusRoute route) async {
    try {
