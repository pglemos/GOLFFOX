...
class _CreateRoutePageState extends ConsumerState<CreateRoutePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: GfAppBar(
        title: widget.route != null ? 'Editar Rota' : 'Nova Rota',
  ...
  void _generateAutomaticRoute() async {
    ...
    try {
      ...
      final generatedRoute = await routeService.generateAutoRoute(
        name: 'Rota Automática ${DateTime.now().day}/${DateTime.now().month}',
        waypoints: waypoints,
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Rota gerada automaticamente com sucesso'),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Erro ao gerar rota: $e'),
  ...
  void _saveRoute() async {
    ...
    if (_stops.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Adicione pelo menos uma parada a rota'),
