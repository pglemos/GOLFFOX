// ========================================
// GolfFox Permissoes Page v11.0 - Clear Theme
// Pagina de controle de permissoes
// ========================================
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Controle de acesso e permissoes do sistema',
              style: TextStyle(
                fontSize: 16,
                ...
                child: const Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Gerenciamento de permissoes e niveis de acesso',
                        style: TextStyle(
                          fontSize: 14,
                          color: Color(GfTokens.textMuted),
                        ),
